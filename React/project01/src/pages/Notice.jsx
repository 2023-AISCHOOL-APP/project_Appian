...
const Notice = () => {
  const notices = [
    ...
    content: '오늘의 점심메뉴는 파스타와 샐러드 조합입니다. 신선한 야채와 고소한 드레싱이 어우러진 샐러드는 건강을 챙기기에 좋고, 풍부한 소스로 풍미를 더한 파스타는 입맛을 만족시켜 줄 것입니다. 메뉴 선택에 고민이 되신다면 이 조합을 추천드립니다. 맛있는 한 끼 식사를 즐기세요!' },
